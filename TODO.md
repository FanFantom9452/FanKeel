...
- 〔stage-agents〕survey 的大腦不派 reader 仍比舊模式貴 2.5–2.8 倍：它用 34、48 次工具，舊模式 5、6 次；brief 要不要叫它把 orient、map、tree、掃描串成一次 Bash，再跑 ab2.sh — [lib/render.js](lib/render.js).
