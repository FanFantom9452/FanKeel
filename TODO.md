...
- The pairs shortlist sees 11 of 22 pages and prints no denominator — [scripts/docs-audit.js](scripts/docs-audit.js)'s `pointsAt` reads neither `<plugin>/` paths nor `source_of_truth`. 08-29.
