...
- Whether `--plan <verb-word>` is a typo worth refusing — [scripts/ledger.js](scripts/ledger.js): `--plan init complete 1 note` writes to `.fankeel/build/init/`. Predates d0d18c4. 08-30.
