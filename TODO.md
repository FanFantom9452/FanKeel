...
- Run the `AskUserQuestion` `PreToolUse` probe in a Claude Code started after the registration — [hooks/gate.js](hooks/gate.js). `start`, ask one question, read `gateAt` while it is open. 09-01.
