...
`scripts/docs-audit.js:647` (`index.exists ? [] :`) reports them only where the project declares no
...
`scripts/docs-audit.js:892` (`function defects(r) {`) and sums drift, landed
