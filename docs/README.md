...
| The four tasks that make a `## Waiting` entry name the event that lifts it, and re-file the thirteen that did not | [plans/2026-09-06-waiting-lifts-when.md](plans/2026-09-06-waiting-lifts-when.md) — *design-intent* |
