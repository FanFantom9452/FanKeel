...
| Why fankeel's three output styles were retired for an on-demand `fankeel-explain` skill and one survey line, and which two parts of the pasted prompt were not taken as written | [plans/2026-09-13-explain-skill-design.md](plans/2026-09-13-explain-skill-design.md) — *design-intent, 繁體中文* |
| The five tasks that deleted `caveman.zip`, gave survey an `unknown:` line, added `fankeel-explain`, recorded why no style ships and deleted the styles | [plans/2026-09-13-explain-skill.md](plans/2026-09-13-explain-skill.md) — *design-intent* |
