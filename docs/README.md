...
| Tasks 2 to 9 of that design, promoted 2026-09-22: lap-numbered handoff files that a rename cannot confuse, `read first:`, `artifact:` and the design and plan commit relay, the implementer route for audit and land, the brain on Sonnet, the permission for handoff writes, the documents that say so, and the release | `docs/archive/2026-09-21-all-stages-brain-held.md` — *built* |
| What that settled — measure first: only `scripts/ctx.js --by-stage` was built, and it was made to read a subagent's own transcript; the other five tasks stay held for now; and what verify caught that build's review did not | [decisions/2026-09-22-ctx-by-stage.md](decisions/2026-09-22-ctx-by-stage.md) — *繁體中文* |
| What superseded that, same day — the user opened the run instead of waiting: Tasks 2 to 9 all built, the brain on Sonnet, the two documents archived once landed, and what is still unmeasured | [decisions/2026-09-22-all-stages-brain-promoted.md](decisions/2026-09-22-all-stages-brain-promoted.md) — *繁體中文* |
