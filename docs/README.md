...
| Why the ten `## Ready` entries came down to eight changes — an archive page is retired wherever it sits, a deleted file no longer holds a plan open, the order of stages is kept beside the clock, and a blank judgement is refused | [plans/2026-09-11-ready-ten-design.md](plans/2026-09-11-ready-ten-design.md) — *design-intent, 繁體中文* |
| The nine tasks that close them, eight of them one change and its test, the last taking the ten entries out of `TODO.md` | [plans/2026-09-11-ready-ten.md](plans/2026-09-11-ready-ten.md) — *design-intent, 繁體中文* |
