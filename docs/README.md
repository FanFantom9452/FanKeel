...
| Why the station skill goes — the `/fankeel` prompt already writes and names the page — and what moves where when it does | [plans/2026-09-07-station-skill-retired-design.md](plans/2026-09-07-station-skill-retired-design.md) — *in progress* |
| The three tasks that retire the skill, catch the station page up with the code, and add `--json` | [plans/2026-09-07-station-skill-retired.md](plans/2026-09-07-station-skill-retired.md) — *in progress* |
