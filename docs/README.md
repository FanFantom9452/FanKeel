...
| Why only one of the three `## Ready` entries of 09-17 was ready — the other two each still carried a decision: a page written once, and a card a plan moved on purpose | [plans/2026-09-17-ready-three-design.md](plans/2026-09-17-ready-three-design.md) — *design-intent, 繁體中文* |
| The two tasks: `tests/memory-check.test.js` onto `tests/tmp.js` with a guard against a direct `mkdtemp`, and the other two entries refiled | [plans/2026-09-17-ready-three.md](plans/2026-09-17-ready-three.md) — *design-intent, 繁體中文* |
