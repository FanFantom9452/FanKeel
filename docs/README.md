...
| Why the scratch area cannot be a `docs.json` bucket however legal the path looks, who owns each of three twice-described mechanisms, and why `source_of_truth` gets no single-owner rule | [plans/2026-09-11-todo-three-design.md](plans/2026-09-11-todo-three-design.md) — *design-intent, 繁體中文* |
| The five tasks that close those three, and the mutation each of the two new guard tests needs to be seen red — both pass the day they are written | [plans/2026-09-11-todo-three.md](plans/2026-09-11-todo-three.md) — *design-intent, 繁體中文* |
