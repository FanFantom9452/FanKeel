...
| Why the seven `fail()` replies no test reached each get one, what makes `station.css` unreadable from a test, and why `docs/station.md`'s `/profile` sentence changes with them | [plans/2026-09-14-station-fail-tests-design.md](plans/2026-09-14-station-fail-tests-design.md) — *design-intent, 繁體中文* |
| The three tasks: seven station tests with the 491–497 mutation that reddens them, three orient alignment assertions with two mutations, and the page sentence and the `TODO.md` entry | [plans/2026-09-14-station-fail-tests.md](plans/2026-09-14-station-fail-tests.md) — *design-intent* |
