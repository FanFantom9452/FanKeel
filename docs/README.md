...
| Why the station's overview becomes three levels — a 30-day histogram, a project page, a session timeline — and why each one reads its time, tokens and money out of one daily split rather than its own scan | [plans/2026-09-14-station-three-levels-design.md](plans/2026-09-14-station-three-levels-design.md) — *design-intent, 繁體中文* |
| The nine tasks that build them: four in `lib/` cutting every request by day, stage, model and who ran it, four on the page rebuilding the shell, the styles, the hash router and the three levels, and one rewriting the documents | [plans/2026-09-14-station-three-levels.md](plans/2026-09-14-station-three-levels.md) — *design-intent, 繁體中文* |
