...
- **花費接近打平，但兩頭都在動。** 組內 1.05× 與 0.97×，第 5 節是 2.5–2.8 倍。大腦便宜了：$0.67 與 $0.47（第 7 節 $0.81、$1.14），thinking 估 2,478 與 1,983（跑 `high` 時是 5,513 與 7,310）。同一段時間舊模式卻變貴：old12、old13 花 $0.93 與 $0.82、用 13 與 14 次工具，第 7 節的 old7、old8 是 $0.45 與 $0.49、4 與 6 次。掃描面仍在長（`ab7/scan-at-0e32d9a.txt` 是 656 個檔）。所以這個打平是兩頭一起靠近的結果，跨批不能直接比，組內可以。
