...
// last seen (`scripts/task.js:507`), and the two no longer answer together. So the
// command carries `--force`, which is the one form that works whichever of them
// the holder happens to be.
//
