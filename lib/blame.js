...
// lines as a history of zero. `-M` keeps a line moved within the file on
// the commit that wrote it: regrouping TODO.md is not an edit to any entry.
function blameTimes(dir, name) {
    const out = git(dir, ['blame', '-M', '--line-porcelain', '--', name]);
