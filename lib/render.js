...
const { rulesFor, templateFor, initRules, INIT_TEMPLATE, normaliseRoute, positionIn, FULL_ROUTE, CLASSES } = require('./stages.js');
...
function rulesLines(data) {
    const rules = rulesFor(data && data.stage, SCRIPTS);
    const lines = [''];
