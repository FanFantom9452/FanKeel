...
const RETURN_RULES = [
    ...
    'You do not change the working tree outside the job you were sent to do. No `git stash`, `git checkout`, `git reset`, `git clean`, no deleting or moving files nobody asked you to change. A parallel reader is working in this same tree, and no hook stops a shell command.',
];
