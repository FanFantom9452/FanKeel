...
const { rulesFor, templateFor, normaliseRoute, positionIn, FULL_ROUTE, CLASSES } = require('./stages.js');
...
const DOCS_CHECK_SCRIPT = path.join(PLUGIN_ROOT, 'scripts', 'docs-check.js');
const DOCS_AUDIT_SCRIPT = path.join(PLUGIN_ROOT, 'scripts', 'docs-audit.js');
const MAP_SCRIPT = path.join(PLUGIN_ROOT, 'scripts', 'map.js');
const LEDGER_SCRIPT = path.join(PLUGIN_ROOT, 'scripts', 'ledger.js');
const RESIDUE_SCRIPT = path.join(PLUGIN_ROOT, 'scripts', 'residue.js');
...
const SCRIPTS = { survey: named('survey.js'), map: named('map.js'), ledger: named('ledger.js'), todoCheck: named('todo-check.js'), docsCheck: named('docs-check.js'), docsAudit: named('docs-audit.js'), residue: named('residue.js') };
...
module.exports = { render, renderResume, renderBrief, RETURN_RULES, SCRIPTS, PLUGIN_ROOT, PLUGIN_MARK, SURVEY_SCRIPT, TODO_CHECK_SCRIPT, DOCS_CHECK_SCRIPT, DOCS_AUDIT_SCRIPT };
