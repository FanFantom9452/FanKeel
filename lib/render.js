...
const SCRIPTS = { survey: named('survey.js'), map: named('map.js'), ledger: named('ledger.js'), todoCheck: named('todo-check.js'), docsCheck: named('docs-check.js'), docsAudit: named('docs-audit.js'), residue: named('residue.js'), orient: named('orient.js'), task: named('task.js'), judge: named('judge.js') };
