...
//
// Filtering the argv after the parser has read it is enough for a dash the
// table does not know. Against one it *does* know there is nothing left to
// filter: `parseArgs` consumed the token and acted on it before any filter
...
module.exports = { splitAtVerb, splitAroundVerb };
