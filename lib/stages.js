...
const STAGES = [
    ...
    },
    {
        ...
        rules: [
            ...
            'From a plan: `node {{LEDGER}} --plan <f> show` first and never redo a task it lists complete. One reviewer per task, then `complete <n> "<what landed>"`. After a compaction trust it over memory.',
