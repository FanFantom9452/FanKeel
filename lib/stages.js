...
const INIT = [
    ...
    'Then `{{TASK}} start` and survey in the same turn. "Entry written, shall I begin?" spends a turn on a question whose answer is always yes, and leaves the badge saying survey before anything is surveyed.',
];
...
module.exports = { ALWAYS, INIT, INIT_TEMPLATE, initRules, STAGES, NAMES, TOKENS, SURVEY_TOKEN, FULL_ROUTE, CLASSES, byName, nextStage, normaliseRoute, positionIn, routeForClass, classForRoute, rulesFor, templateFor };
