...
// granted: `build` now sits 6 characters under that cap.
const ALWAYS = [
    'Never end a stage silently or in prose. Ask with AskUserQuestion — three at least, never dropping the pause. Option one is the approval: {{NEXT}} — mark your pick `(Recommended)` rather than moving it. Option two names the open decision, never unfinished work.',
