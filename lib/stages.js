...
const STAGES = [
    ...
    },
    {
        ...
        rules: [
            ...
            'Every fortnight add the deep pass: /fankeel-audit runs `node {{DOCS_AUDIT}}` and offers the cleanup. Other tools answer in the same breath — /ponytail-audit for code, knip and deptry for unused packages, invoked as below — and say which are not installed.',
