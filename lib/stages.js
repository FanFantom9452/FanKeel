...
const STAGES = [
    ...
    },
    {
        ...
        rules: [
            ...
            'Every `## Task N:` carries `**Files:**` and a `**Dispatch:**` line \u2014 `implementer, <model>` or `in-session`. `sonnet` is the floor and needs no argument; anything above it names on that same line what the task needs that transcription does not. A task without either is a plan failure.',
