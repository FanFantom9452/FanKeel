...
const STAGES = [
    {
        ...
        rules: [
            'Before creating anything — a component, a helper, a document — run `node {{SURVEY}} <term> [term...]` and quote what came back. Nothing matched is a finding; say which terms you tried.',
    ...
    },
    {
        ...
        rules: [
            ...
            'One approach and what it costs, in the fewest words that let someone say yes or no. Not a catalogue of options.',
        ],
    },
    {
        name: 'build',
    ...
    },
    {
        ...
        rules: [
            ...
            'Close the TODO.md entries this work finished, then run `node {{TODO_CHECK}}`. The plan you just deleted is a link that just died.',
...
// Two rules name a script, and a script's path is only knowable at run time.
...
module.exports = { ALWAYS, STAGES, NAMES, TOKENS, SURVEY_TOKEN, byName, nextStage, rulesFor };
