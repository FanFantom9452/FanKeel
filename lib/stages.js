...
// granted: `build` now sits 18 characters under that cap.
const ALWAYS = [
...
const STAGES = [
    ...
    },
    {
        ...
        rules: [
            ...
            'Every fortnight /fankeel-audit adds the deep pass: `node {{DOCS_AUDIT}}` and offers the cleanup. Alongside it: /ponytail-audit for code.',
