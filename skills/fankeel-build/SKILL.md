...
| A ruling recorded instead of a fifth stopper firing | `lib/stages.js:301` names deciding as the normal outcome (`Decide`) — only irreversible, security-sensitive, out-of-workspace or every-path-a-guess actually stop the loop. |
