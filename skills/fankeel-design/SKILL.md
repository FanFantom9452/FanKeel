...
| The map check returning `no conflict` with nothing else said | `lib/stages.js:249` allows exactly that (`say none was found`) — a stated absence is a complete answer, not a check cut short. |
