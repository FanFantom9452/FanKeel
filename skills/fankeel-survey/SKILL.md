...
(`scripts/task.js:494`, `already owns an active task`). What this step writes is
...
`route` takes the stages and derives the class from them (`scripts/task.js:1078`, `classForRoute(given)`);
