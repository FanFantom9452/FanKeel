...
| **landed plans** | a plan where everything named now exists or git has seen it deleted, and nobody has touched it for three days. That settle period is its own, not the drift window. Offer to archive; never move one unasked. |
